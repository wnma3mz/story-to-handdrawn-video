#!/usr/bin/env python3
"""Portable Skill wrapper for exact illustration-master QC."""
...
def find_project() -> Path:
    ...
    for candidate in candidates:
        script = candidate / "scripts/audit-illustration-masters.py"
...
if __name__ == "__main__":
    ...
    os.chdir(project)
    runpy.run_path(
        str(project / "scripts/audit-illustration-masters.py"),
        run_name="__main__",
    )
