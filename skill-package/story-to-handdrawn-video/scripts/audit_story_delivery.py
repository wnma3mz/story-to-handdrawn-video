#!/usr/bin/env python3
"""Portable Skill wrapper for narrated-release QC."""
...
def find_project() -> Path:
    ...
    for candidate in candidates:
        script = candidate / "scripts/audit_story_delivery.py"
...
if __name__ == "__main__":
    ...
    os.chdir(project)
    runpy.run_path(str(project / "scripts/audit_story_delivery.py"), run_name="__main__")
